...
from ..generated import F8OperatorSpec, F8StateAccess, F8StateSpec
from ..schema_helpers import operator_key, schema_default
...
class OperatorInstance:
    ...
    def from_spec(
        ...
        *,
        ...
        instance_id = id or operator_key(template.serviceClass, template.operatorClass)
